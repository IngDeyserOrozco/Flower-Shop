...
<body>
    ...
    <main class="seccion">
        <h2 class="fw-300 centrar-texto">Compras</h2>
            ...
            <section class="listado-compras">
                <table>
                    <thead class="thead">
                        <tr>
                            <th class="th-principal centrar-texto">id</th>
                            <th class="th-principal centrar-texto">Usuario</th>
                            <th class="th-principal centrar-texto">Direccion</th>
                            <th class="th-principal centrar-texto">Producto</th>
                            <th class="th-principal centrar-texto">Precio</th>
                            <th class="th-principal centrar-texto">Fecha</th>
                            <th class="th-principal centrar-texto">Cantidad</th>
                            <th class="th-principal centrar-texto">Estado de Compra</th>
                            <th class="th-principal centrar-texto">Total</th>
                        </tr>
                    </thead>
                    <tbody class="tbody">
                    </tbody>
